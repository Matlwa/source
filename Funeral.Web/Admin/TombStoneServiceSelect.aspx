            ...
            <div class="ibox ">
                ...
                <div class="ibox float-e-margins">
                 <div class="ibox-title">
                     <div class="row">
                         <div class="col-sm-6"><h5>Invoice</h5></div>
                         <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                    <asp:TextBox runat="server" ID="txtNotes" name="CompanyRules" type="text" class="form-control" TextMode="MultiLine" Rows="4" ReadOnly="true"></asp:TextBox>
                                        </div>
                                    <%--<asp:RequiredFieldValidator Display="None" ValidationGroup="CompanySetup" ControlToValidate="txtcompanyRules" ID="RequiredFieldValidator20" ForeColor="red" runat="server" ErrorMessage="Please enter Company Rules"></asp:RequiredFieldValidator>--%>
                                </div>
                                <div class="form-group">
