                            ...
                            <div class="panel-heading">
                                <div class="panel-options" id="Tabs">
                                    <ul class="nav nav-tabs" id="myTab">
                                        <li class="active" id="tab1"><a data-toggle="tab" href="#tab-1" aria-expanded="true">Vehicle History</a></li>
                                        <li class="" id="tab2"><a data-toggle="tab" href="#tab-2" aria-expanded="false">Mileage History</a></li>
                                        <li class="" id="tab3"><a data-toggle="tab" href="#tab-3" aria-expanded="false">Service History</a></li>
                                        </ul>
                                        </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <label>Make </label>
                                                    <asp:DropDownList runat="server" ID="dropDownMake" class="form-control m-b" OnSelectedIndexChanged="Page_Load">
                                                <asp:ListItem Value="0">Select</asp:ListItem>
                                                <asp:ListItem Value="1">Toyota</asp:ListItem>
                                                <asp:ListItem Value="2">Mercedes Benz</asp:ListItem>
                                                <asp:ListItem Value="3">VW</asp:ListItem>
                                                <asp:ListItem Value="4">Chevrollet</asp:ListItem>
                                               
                                            </asp:DropDownList>
                                             </div>
                                                <div class="form-group">
                                                    <label>Model  </label>
                                                   <asp:DropDownList runat="server" ID="dropDownModel" class="form-control m-b">
                                                
                                            </asp:DropDownList>
                                                </div>
                                                <div class="form-group">
                                                    <label>Year  </label>
                                                    <asp:DropDownList runat="server" ID="dropDownlYear" class="form-control m-b">
                                            </asp:DropDownList>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label>Colour </label>
                                                    <asp:DropDownList runat="server" ID="dropDownlColour" class="form-control m-b">
                                            </asp:DropDownList>
                                                    <br />
                                                    <label>Year of Registration</label>
                                                    <asp:TextBox MaxLength="10" runat="server" ID="yearOfRegTextBox" name="txtReg" type="text" class="form-control"></asp:TextBox>
                                                    ...
                                                    <asp:TextBox MaxLength="10" runat="server" ID="licenceRenewalTextBox" name="txtReg" type="text" class="form-control"></asp:TextBox>
                                                    <%--<button class="btn btn-sm btn-primary pull-right m-t-n-xs" onclick="return goToTab(4);">Next</button>--%></div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <%--<asp:RequiredFieldValidator ValidationGroup="tab4" ControlToValidate="txtStreetPostalAddress" ID="RequiredFieldValidator15" ForeColor="red" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>--%><%--<asp:RequiredFieldValidator ValidationGroup="tab4" ControlToValidate="txtStreetPostalAddress" ID="RequiredFieldValidator15" ForeColor="red" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>--%>
                                                </div>
                                              </div>
                                            <div class="col-lg-12">
