                            ...
                            <div class="panel-heading">
                                <div class="panel-options" id="Tabs">
                                    <ul class="nav nav-tabs" id="myTab">
                                        <li class="active" id="tab1"><a data-toggle="tab" href="#tab-1" aria-expanded="true">Claims Details</a></li>
                                        ...
                                        <li class="" id="tab4"><a data-toggle="tab" href="#tab-4" aria-expanded="false">Claim Schedule</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div id="tab-4" class="tab-pane">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="btn-group">
                                                        <asp:Button class="btn btn-sm btn-primary pull-right m-t-n-xs" Visible="true" ID="btnPrintSched" runat="server" Text="Print" />
                                                    </div>
                                                    <div class="form-group">
                                                        <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" AllowSorting="True">
                                                            <PagerStyle CssClass="pagination-ys" />
                                                            <Columns>
                                                ...
                                                <div class="form-group">
                                                    <asp:GridView ID="gvClaims" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gvClaims_PageIndexChanging" CssClass="table table-striped table-bordered table-hover" AllowPaging="True" AllowSorting="True" DataKeyNames="pkiClaimID" OnRowCommand="gvClaims_RowCommand" OnSorting="gvClaims_Sorting">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="Status" HeaderText="Status" HeaderStyle-CssClass="visible-lg" />
                                                            <asp:TemplateField HeaderText="Action">
                                                                <ItemTemplate>
                                                                    ...
                                                                    &nbsp; &nbsp;
                                                                     <asp:LinkButton runat="server" ID="LinkButton1" ToolTip="Click here To Change Status" CommandArgument='<%#Eval("pkiClaimID") %>' CommandName="ChangeStatus"><i class="glyphicon glyphicon-ok-sign"></i></asp:LinkButton>
                                                                <%} %>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
