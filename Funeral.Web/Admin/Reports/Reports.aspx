                                            ...
                                            <div class="panel-title">
                                                    ...
                                                    <div class="panel panel-primary">
                                                        ...
                                                        <div class="panel-body">
                                                            <div role="form" class="form col-sm-12">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="">Start Date From </label>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <label class="" >Start Date To </label>
                                                                ...
                                                                <%--<div class="col-sm-6">--%>
                                                                    <%--<div class="form-group">--%>
                                                                        <%--<label class="">Debit Date From </label>--%>
                                                                       <%-- <asp:RequiredFieldValidator ValidationGroup="pnlPolicyStatus" ID="RequiredFieldValidator29" ForeColor="Red" ControlToValidate="txtPolicyDateFrom" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>--%>
                                                                        <%--<asp:TextBox CssClass="form-control datepicker" placeholder="DD/MM/YYYY" ID="txtDebitDateFrom" runat="server"></asp:TextBox>--%>
                                                                    <%--</div>--%>
                                                                <%--</div>--%>
                                                                <%--<div class="col-sm-6">--%>
                                                                    <%--<div class="form-group">--%>
                                                                        <%--<label class="">Debit Date To</label><asp:TextBox CssClass="form-control datepicker" placeholder="DD/MM/YYYY" ID="txtDebitDateTo" runat="server"></asp:TextBox>--%>
                                                                    <%--</div>--%>
                                                                <%--</div>--%>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <asp:DropDownList CssClass="form-control" ID="ddlAgent" runat="server">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox MaxLength="25" runat="server" ID="txtcemail" name="name" type="text" class="form-control"></asp:TextBox>
