                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ValidationGroup="tab1" ControlToValidate="ddlNoOfMonths" InitialValue="0"
                                                ID="RequiredFieldValidator1" ForeColor="red" runat="server" ErrorMessage="Select Number of Months"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <%--<asp:Button runat="server" ID="btnRejoin" Width="95%" CssClass="btn btn-md btn-primary" Text="Rejoin Policy" OnClick="btnRejoin_Click" />--%>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
