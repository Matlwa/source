...
namespace Funeral.Services
{
    ...
    public class FuneralServices : IFuneralServices
    {
        ...
        public int SaveBank(BankModel model)
        {
            return BanksBAL.SaveBank(model);
        }
        ...
        public List<PolicyModel> GetPlanSubscriptionByPlanId(int pkiPlanID)
        {
            return CommonBAL.GetPlanSubscriptionByPlanId(pkiPlanID);
        }
        ...
        public int SaveVehicle(VehiclesModel model)
        {
            try
            {
                return MembersBAL.SaveVehicle(model);
            }
            catch (Exception exc)
            {
                throw new FaultException<FuneralServiceFault>(new FuneralServiceFault(exc.Message));
        ...
        {
            return BanksBAL.SelectBankByID(Id);
        }
        public List<BankModel> GetLastBank()
        {
            return BanksBAL.SelectLastBank();
        }
        ...
        public MembersPaymentViewModel GetAllPayentMembers(Guid ParlourId, string PolicyNo, string IDNumber, int PageSize, int PageNum, string SortBy, string SortOrder)
        {
            return MemberPaymentBAL.GetAllPayentMembers(ParlourId, PolicyNo, IDNumber, PageSize, PageNum, SortBy, SortOrder);
        }
        ...
        public List<ClaimsModel> SelectAllClaimsByParlourId(Guid ParlourId, int PageSize, int PageNum, string Keyword, string SortBy, string SortOrder, DateTime DateFrom, DateTime DateTo)
        {
            return ClaimsBAL.SelectAllClaimsByParlourId(ParlourId, PageSize, PageNum, Keyword, SortBy, SortOrder, DateFrom, DateTo);
        }
        ...
        public void SaveOrderMember(MembersModel model)
        {
            MembersBAL.SaveOrderMember(model);
        }
        public MembersViewModel GetAllDebitOrderMembers(Guid ParlourId, int PageSize, int PageNum, string Keyword, string SortBy, string SortOrder)
        {
