...
namespace Funeral.Services
{
    ...
    public interface IFuneralServices
    {
        ...
        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        MembersViewModel GetAllMembers(Guid ParlourId, int PageSize, int PageNum, string Keyword, string SortBy, string SortOrder);

        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        MembersViewModel GetAllDebitOrderMembers(Guid ParlourId, int PageSize, int PageNum, string Keyword, string SortBy, string SortOrder);
        ...
        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        List<PolicyModel> GetPlanSubscriptionByPlanId(int pkiPlanID);
        ...
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        [FaultContract(typeof(FuneralServiceFault))]
        int SaveVehicle(VehiclesModel model);

        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        VehiclesModel GetVehicleByVinNo(string VinNo, Guid ParlourId, int MemberID);

        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        List<VehiclesModel> GetVehicleByMemberID(int MemberId);
        ...
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        [FaultContract(typeof(FuneralServiceFault))]
        int UpdateVehicle(VehiclesModel model);

        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        VehiclesModel SelectVehicleByVehicleId(int pkiVehicleID);
        ...
        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        BankModel SelectBankByID(int Id);

        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        List<BankModel> GetLastBank();
        ...
        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        MembersPaymentViewModel GetAllPayentMembers(Guid ParlourId, string PolicyNo, string IDNumber, int PageSize, int PageNum, string SortBy, string SortOrder);
        ...
        [OperationContract]
        [WebInvoke(ResponseFormat = WebMessageFormat.Json)]
        List<ClaimsModel> SelectAllClaimsByParlourId(Guid ParlourId, int PageSize, int PageNum, string Keyword, string SortBy, string SortOrder, DateTime DateFrom, DateTime DateTo);
